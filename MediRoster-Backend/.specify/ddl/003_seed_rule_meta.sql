...
('structure.min_lin', 'HEADCOUNT', '周一至周五每天至少「临」侧（骨髓全算临）', 'INT', '2', NULL, 'REQ-DAILY-05', 21, 1),
('structure.min_lin_weekend', 'HEADCOUNT', '周六、周日每天至少「临」侧（骨髓全算临）', 'INT', '1', NULL, '周末与工作日区分', 22, 1),
